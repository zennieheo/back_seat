...
ALLOWED_HOSTS = ['43.204.215.201', '127.0.0.1', 'localhost']
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [("bb.fsm4zb.ng.0001.apn2.cache.amazonaws.com", 6379)], 
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://bb.fsm4zb.ng.0001.apn2.cache.amazonaws.com:6379/1',
        'OPTIONS': {
